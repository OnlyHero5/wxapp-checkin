...
- 当前缺口（仍建议补“单文档总览”）：
  - `wxapp-checkin/web -> wxapp-checkin/backend -> outbox -> suda_union -> suda-gs-ams` 的闭环验证证据已落盘在 `docs/TEST_REPORT_2026-03-11_FULL_COVERAGE.md`；后续可再整理成“一页式总览”，方便新对话快速跳转
