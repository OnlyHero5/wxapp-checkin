...
> **注意：** 本文档基于当时的 Passkey/WebAuthn 认证方案编写。自 2026-03-10 起认证基线已调整为 **HTTP 内网账号密码（默认 123，首次登录强制改密）**。请以 `docs/plans/2026-03-10-http-password-auth-design.md` 为准；本文仅保留为历史回溯。
